...
export default function LandingHero() {
  return (
    <section className="relative flex flex-col items-center justify-center text-center px-6 pt-32 pb-28 md:pt-40 md:pb-36 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto space-y-8 z-10 flex flex-col items-center">
        {/* Centered Pill Badge */}
        <div className="inline-flex items-center text-sm gap-2 bg-background px-1 py-1 pr-3 rounded-full border border-border shadow-sm animate-fade-in mb-5">
        ...
        <h1 className="text-4xl md:text-[58px] animate-fade-in font-semibold tracking-tight text-foreground md:leading-16 leading-tight max-w-3xl">
        ...
        {/* Subtext description */}
        <p className="text-muted-foreground text-xl animate-fade-in max-w-2xl">
        ...
        <div className="relative mt-16 w-full max-w-5xl flex flex-col items-center">
          ...
          <div className="absolute inset-0 -z-10 flex justify-between items-center pointer-events-none w-[110%] translate-x-[-5%] translate-y-[-5%]">
            <div className="w-125 h-125] bg-foreground-blue rounded-full blur-[130px] mix-blend-normal animate-pulse-slow" />
            <div className="w-125 h-125 bg-foreground-blue rounded-full blur-[130px] mix-blend-normal animate-pulse-slow" />
          </div>
        ...
        {/* Trusted Logos Carousell / Marquee */}
        <div className="w-full pt-16 space-y-4">
          <p className="text-[10px]  text-muted-foreground uppercase tracking-widest">
            Already trusted by industry leaders
          </p>
          <div className="w-full overflow-hidden relative py-3 bg-secondary/15 rounded-xl border border-border/30">
            <div className="flex gap-16 animate-marquee whitespace-nowrap min-w-full justify-around items-center">
              {[
                "ServiceTitan",
                "Housecall Pro",
                "Twilio",
                ...
                <span
                  key={idx}
                  className="text-muted-foreground hover:text-foreground transition-colors font-black text-md uppercase tracking-widest"
                >
                  ⚡ {logo}
                </span>
              ))}
